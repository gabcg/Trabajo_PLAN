...
Queremos detectar los efectos principales del dispositivo (2 niveles) y la visibilidad (2 niveles) para Δ = 5 y𝜎 = 5.24 (sqrt(mmE))
...
Queremos detectar interacciones entre el dispositivo  (2 niveles) y la viibilidad (2 niveles), con Δ = 6 y suponiendo 𝜎 = 5.24 (lo tratamos como ANOVA de un factor con 2x2=4 niveles):
```{r}
library(daewr)
sigma <- sqrt(27.42) 
alpha <- .05

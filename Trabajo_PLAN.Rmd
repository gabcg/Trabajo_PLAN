...
Vemos que solo el dispositivo es significativo. También el bloque. El tipo de test o su interacción con el dispositivo no lo son.
...
Por último, estimamos los parámetros del modelo:

...
$$
Palabras_i = \mu + \beta_{Dispositivo, d(i)} + \beta_{Test,t(i)} + \alpha\beta_{d(i),t(i)}+\epsilon_i
$$
...
$$
Palabras_i = \mu + \beta_{Dispositivo, d(i)} + \beta_{Test,t(i)} +\epsilon_i
$$
...
+ 1.958 \ I(I_i = 1) -4.208 \ I(I_i = 2) + 2.250 \ I(I_i = 3)
\end{array}
